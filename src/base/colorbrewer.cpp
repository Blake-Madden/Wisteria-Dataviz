...
// clang-format off
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::ColorScheme, wxObject)
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::Dusk, ColorScheme)
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::EarthTones, ColorScheme)
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::Decade1920s, ColorScheme)
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::Decade1940s, ColorScheme)
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::Decade1950s, ColorScheme)
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::Decade1960s, ColorScheme)
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::Decade1970s, ColorScheme)
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::Decade1980s, ColorScheme)
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::Decade1990s, ColorScheme)
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::Decade2000s, ColorScheme)
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::October, ColorScheme)
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::Slytherin, ColorScheme)
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::Campfire, ColorScheme)
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::CoffeeShop, ColorScheme)
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::ArcticChill, ColorScheme)
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::BackToSchool, ColorScheme)
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::BoxOfChocolates, ColorScheme)
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::Cosmopolitan, ColorScheme)
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::DayAndNight, ColorScheme)
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::FreshFlowers, ColorScheme)
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::IceCream, ColorScheme)
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::UrbanOasis, ColorScheme)
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::Typewriter, ColorScheme)
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::TastyWaves, ColorScheme)
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::Spring, ColorScheme)
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::ShabbyChic, ColorScheme)
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::RollingThunder, ColorScheme)
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::ProduceSection, ColorScheme)
wxIMPLEMENT_DYNAMIC_CLASS(Wisteria::Colors::Schemes::Nautical, ColorScheme)
