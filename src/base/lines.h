...
namespace Wisteria::GraphItems
    ...
    class Lines final : public GraphItems::GraphItemBase
      ...
      public:
        ...
        Lines(const wxPen& pen, const double scaling) : GraphItemBase(scaling, wxString{})
            {
            GetPen() = pen;
            }
        ...
        void Reserve(const size_t size) { m_lines.reserve(size); }
        ...
        void AddLine(const wxPoint pt1, const wxPoint pt2) { m_lines.emplace_back(pt1, pt2); }
