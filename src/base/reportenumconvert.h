...
namespace Wisteria
    ...
    public:
        //---------------------------------------------------
        [[nodiscard]]
        static std::shared_ptr<Colors::Schemes::ColorScheme> ConvertColorScheme(wxString schemeColor)
            {
            static std::map<std::wstring_view, std::shared_ptr<Colors::Schemes::ColorScheme>> colorSchemes =
                {
            ...
            const auto foundPos = colorSchemes.find(std::wstring_view(schemeColor.MakeLower().wc_str()));
            return (foundPos != colorSchemes.cend() ?
                foundPos->second :
                nullptr);
            }
        ...
        static std::optional<Icons::IconShape> ConvertIcon(wxString iconStr)
            ...
            static const std::map<std::wstring_view, Icons::IconShape> iconEnums =
                ...
                { L"horizontal-arrow-right-separator", Icons::IconShape::HorizontalArrowRightSeparator },
        ...
        //---------------------------------------------------
        [[nodiscard]]
        static std::optional<Graphs::GanttChart::TaskLabelDisplay> ConvertTaskLabelDisplay(const wxString& value)
            {
            static const std::map<std::wstring, Graphs::GanttChart::TaskLabelDisplay> taskLabelDisplays =
                {
                { L"days", Graphs::GanttChart::TaskLabelDisplay::Days },
                { L"description", Graphs::GanttChart::TaskLabelDisplay::Description },
                { L"description-and-days", Graphs::GanttChart::TaskLabelDisplay::DescriptionAndDays },
                ...
                { L"resource-and-description", Graphs::GanttChart::TaskLabelDisplay::ResourceAndDescription },
                { L"resource-description-and-days", Graphs::GanttChart::TaskLabelDisplay::ResourceDescriptionAndDays }
                };
        ...
        //---------------------------------------------------
        [[nodiscard]]
        static std::optional<Graphs::CandlestickPlot::PlotType> ConvertCandlestickPlotType(
        ...
        static std::optional<Graphs::LikertChart::LikertSurveyQuestionFormat>
            ...
            {
            static const std::map<std::wstring, Graphs::LikertChart::LikertSurveyQuestionFormat> surveyTypes =
                {
                { L"two-point", Graphs::LikertChart::LikertSurveyQuestionFormat::TwoPoint },
                { L"two-point-categorized", Graphs::LikertChart::LikertSurveyQuestionFormat::TwoPointCategorized },
                { L"three-point", Graphs::LikertChart::LikertSurveyQuestionFormat::ThreePoint },
                { L"threepoint-categorized", Graphs::LikertChart::LikertSurveyQuestionFormat::ThreePointCategorized },
                { L"four-point", Graphs::LikertChart::LikertSurveyQuestionFormat::FourPoint },
                { L"four-point-categorized", Graphs::LikertChart::LikertSurveyQuestionFormat::FourPointCategorized },
                { L"five-point", Graphs::LikertChart::LikertSurveyQuestionFormat::FivePoint },
                { L"five-point-categorized", Graphs::LikertChart::LikertSurveyQuestionFormat::FivePointCategorized },
                { L"six-point", Graphs::LikertChart::LikertSurveyQuestionFormat::SixPoint },
                { L"six-point-categorized", Graphs::LikertChart::LikertSurveyQuestionFormat::SixPointCategorized },
                { L"seven-point", Graphs::LikertChart::LikertSurveyQuestionFormat::SevenPoint },
                { L"seven-point-categorized", Graphs::LikertChart::LikertSurveyQuestionFormat::SevenPointCategorized }
                };

            const auto foundValue = surveyTypes.find(value.Lower().ToStdWstring());
            return ((foundValue != surveyTypes.cend()) ?
                std::optional<Graphs::LikertChart::LikertSurveyQuestionFormat>(foundValue->second) :
                std::nullopt);
            }
        ...
        //---------------------------------------------------
        [[nodiscard]]
        static std::optional<Graphs::Histogram::BinningMethod> ConvertBinningMethod(const wxString& value)
            {
        ...
        //---------------------------------------------------
        [[nodiscard]]
        static std::optional<Graphs::Histogram::IntervalDisplay> ConvertIntervalDisplay(const wxString& value)
            {
        ...
        static std::optional<Graphs::Roadmap::LaneSeparatorStyle> ConvertLaneSeparatorStyle(const wxString& value)
            {
            // use standard string, wxString should not be constructed globally
            static const std::map<std::wstring, Graphs::Roadmap::LaneSeparatorStyle> bDisplayValues =
                {
        ...
        //---------------------------------------------------
        [[nodiscard]]
        static std::optional<Graphs::Roadmap::RoadStopTheme> ConvertRoadStopTheme(const wxString& value)
            {
            // use standard string, wxString should not be constructed globally
        ...
        //---------------------------------------------------
        [[nodiscard]]
        static std::optional<Graphs::Roadmap::MarkerLabelDisplay> ConvertMarkerLabelDisplay(const wxString& value)
            {
            // use standard string, wxString should not be constructed globally
            static const std::map<std::wstring, Graphs::Roadmap::MarkerLabelDisplay> bDisplayValues =
                {
                { L"name", Graphs::Roadmap::MarkerLabelDisplay::Name },
                { L"name-and-absolute-value", Graphs::Roadmap::MarkerLabelDisplay::NameAndAbsoluteValue },
                { L"name-and-value", Graphs::Roadmap::MarkerLabelDisplay::NameAndValue }
                };
