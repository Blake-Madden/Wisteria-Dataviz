...
class Screenshot
  ...
  public:
    ...
    /** @brief Saves a screenshot of the active window, and an annotation written
            over provided control(s).
        @param filePath The path to save the screenshot to.
        ...
        @returns @c true if image is saved successfully.*/
    static bool SaveScreenshot(const wxString& filePath, const wxString& annotation,
    ...
    /** @brief Saves a screenshot of the top-level ribbon.
        ...
        @param firstButtonBarToHighlight The first (or only) button bar area
            (on the active page) to highlight.
        @param lastButtonBarToHighlight The last button bar area (on the active page) to
            include in the highlighting.
        ...
        @returns @c true if image is saved successfully.*/
    static bool SaveScreenshotOfRibbon(const wxString& filePath, const int pageToSelect = 0,
    ...
    static bool HighlightItemInScreenshot(const wxString& filePath, const wxPoint topLeftCorner,
    ...
    /** @brief Opens a screenshot and draws a text box at the provided area.
        ...
        @returns @c true if image is saved successfully.
        @warning The file needs to be a bitmap.*/
    static bool AnnotateScreenshot(const wxString& filePath, const wxString& text,
                                   const wxPoint topLeftCorner, const wxPoint bottomRightCorner);

    /** @brief Opens a screenshot and crops to the provided dimensions.
        @param filePath The path of the image to open.
        @param width The width to crop the image to. Leave as @c wxDefaultCoord
            to not crop the width.
        @param height The width to crop the image to.
            Leave as @c wxDefaultCoord to not crop the height.
        @returns @c true if image is saved successfully.
        @warning The file needs to be a bitmap.*/
    static bool CropScreenshot(const wxString& filePath, wxCoord width = wxDefaultCoord,
