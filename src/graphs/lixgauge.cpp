...
LixGauge::LixGauge(Wisteria::Canvas* canvas,
    ...
    GetTitle() =
        GraphItems::Label(GraphItemInfo(_(L"Lix standards")).Scaling(GetScaling()).Pen(wxNullPen));
    }

//----------------------------------------------------------------
void LixGauge::SetData(std::shared_ptr<const Data::Dataset> data, const wxString& scoreColumnName,
...
void LixGauge::AdjustAxes()
    ...
    const auto getMinMaxForRange = [this]()
    {
        if (GetDataset() != nullptr)
            {
            const auto [minVal, maxVal] = std::minmax_element(m_scoresColumn->GetValues().cbegin(),
    ...
    GetCustomAxes().clear();
        ...
        leftRuler.AddBracket(
            Axis::AxisBracket(20, 20, 20, _(L"Very easy text"), wxColour(66, 51, 251)));
        leftRuler.AddBracket(
            Axis::AxisBracket(30, 30, 30, _(L"Easy text"), wxColour(163, 182, 250)));
        leftRuler.AddBracket(
            Axis::AxisBracket(40, 40, 40, _(L"Average text"), wxColour(239, 173, 186)));
        leftRuler.AddBracket(
            Axis::AxisBracket(50, 50, 50, _(L"Difficult text"), wxColour(237, 27, 37)));
        leftRuler.AddBracket(
            Axis::AxisBracket(60, 60, 60, _(L"Very difficult text"), wxColour(250, 0, 0)));
        ...
        rightRuler.AddBracket(
            Axis::AxisBracket(25, 25, 25, _(L"Books for children"), wxColour(138, 163, 249)));
        rightRuler.AddBracket(
            Axis::AxisBracket(35, 35, 35, _(L"Fiction"), wxColour(207, 217, 252)));
        rightRuler.AddBracket(
            Axis::AxisBracket(45, 45, 45, _(L"Factual prose"), wxColour(245, 126, 133)));
        rightRuler.AddBracket(
            Axis::AxisBracket(55, 55, 55, _(L"Technical literature"), wxColour(237, 10, 10)));
