...
namespace Wisteria::UI
    ...
    bool ImageExportDlg::Create(wxWindow* parent, const wxBitmapType bitmapType,
        ...
        Bind(wxEVT_RADIOBOX, &ImageExportDlg::OnOptionsChanged, this,
             ControlIDs::COLOR_MODE_COMBO_ID);
    ...
    void ImageExportDlg::CreateControls(const wxBitmapType bitmapType)
        ...
        auto* widthLabel = new wxStaticText(imageSizeSizer->GetStaticBox(), wxID_STATIC,
        ...
        if (bitmapType == wxBITMAP_TYPE_TIF)
            ...
            auto* compressionLabel =
                new wxStaticText(tiffOptionsBoxSizer->GetStaticBox(), wxID_STATIC,
                                 _(L"Compression:"), wxDefaultPosition, wxDefaultSize, 0);
            compressionSizer->Add(compressionLabel,
