...
#ifndef INSERT_MULTI_SERIES_LINEPLOT_DIALOG_H
#define INSERT_MULTI_SERIES_LINEPLOT_DIALOG_H
    ...
    /** @brief Dialog for inserting a multi-series line plot into a canvas cell.
        @details Extends InsertGraphDlg with an "Options" page containing:
            ...
            - A "Variables..." button that opens a VariableSelectDlg
              for selecting multiple Y columns and a single X column.
            - Labels showing the current variable selections.
            - A checkbox for auto-splining.
            - Legend placement.*/
    class InsertMultiSeriesLinePlotDlg final : public InsertGraphDlg
        {
      public:
        /** @brief Constructor.
        ...
        InsertMultiSeriesLinePlotDlg(
            Canvas* canvas, const ReportBuilder* reportBuilder, wxWindow* parent,
            const wxString& caption = _(L"Insert Multi-Series Line Plot"), wxWindowID id = wxID_ANY,
            const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize,
            long style = wxDEFAULT_DIALOG_STYLE | wxCLIP_CHILDREN | wxRESIZE_BORDER,
            EditMode editMode = EditMode::Insert);

        /// @private
        InsertMultiSeriesLinePlotDlg(const InsertMultiSeriesLinePlotDlg&) = delete;
        /// @private
        InsertMultiSeriesLinePlotDlg& operator=(const InsertMultiSeriesLinePlotDlg&) = delete;
        ...
        /// @returns The Y variable names (continuous columns for each series).
        [[nodiscard]]
        const std::vector<wxString>& GetYVariables() const noexcept
            {
            return m_yVariables;
            }
      ...
      private:
        ...
        wxStaticText* m_yVarsLabel{ nullptr };
...
#endif // INSERT_MULTI_SERIES_LINEPLOT_DIALOG_H
