...
void OpacityDlg::CreateControls()
    ...
    mainSizer->Add(new wxSlider(this, wxID_ANY,
            m_opacity,0,255,wxDefaultPosition, wxDefaultSize,wxSL_HORIZONTAL|wxSL_LABELS|wxSL_AUTOTICKS, wxGenericValidator(&m_opacity)),
            wxSizerFlags(0).Expand().Border(wxALL,wxSizerFlags::GetDefaultBorder()));

    mainSizer->Add(CreateSeparatedButtonSizer(wxOK|wxCANCEL), 0, wxEXPAND|wxALL, wxSizerFlags::GetDefaultBorder());
