...
namespace Wisteria::UI
    ...
    class InsertPageDlg final : public DialogWithHelp
      ...
      private:
        ...
        bool DropHistogram(Canvas* stagingCanvas, size_t row, size_t col);
        bool DropBoxPlot(Canvas* stagingCanvas, size_t row, size_t col);
        bool DropStemAndLeaf(Canvas* stagingCanvas, size_t row, size_t col);
        bool DropHeatMap(Canvas* stagingCanvas, size_t row, size_t col);
        bool DropScatterPlot(Canvas* stagingCanvas, size_t row, size_t col);
        bool DropBubblePlot(Canvas* stagingCanvas, size_t row, size_t col);
        bool DropChernoffFacesPlot(Canvas* stagingCanvas, size_t row, size_t col);
        bool DropWilmarthBridgePlot(Canvas* stagingCanvas, size_t row, size_t col);
        bool DropWinLossSparkline(Canvas* stagingCanvas, size_t row, size_t col);
        bool DropGanttChart(Canvas* stagingCanvas, size_t row, size_t col);
        bool DropCandlestickPlot(Canvas* stagingCanvas, size_t row, size_t col);
        bool DropScaleChart(Canvas* stagingCanvas, size_t row, size_t col);
        bool DropWCurvePlot(Canvas* stagingCanvas, size_t row, size_t col);
        bool DropLRRoadmap(Canvas* stagingCanvas, size_t row, size_t col);
        bool DropLikertChart(Canvas* stagingCanvas, size_t row, size_t col);
        bool DropWordCloud(Canvas* stagingCanvas, size_t row, size_t col);
        bool DropProConRoadmap(Canvas* stagingCanvas, size_t row, size_t col);
        bool DropBarChart(Canvas* stagingCanvas, size_t row, size_t col);
        bool DropPieChart(Canvas* stagingCanvas, size_t row, size_t col);
        bool DropLinePlot(Canvas* stagingCanvas, size_t row, size_t col);
        bool DropMultiSeriesLinePlot(Canvas* stagingCanvas, size_t row, size_t col);
        bool DropTable(Canvas* stagingCanvas, size_t row, size_t col);
        bool DropChoroplethMap(Canvas* stagingCanvas, size_t row, size_t col);
        bool DropSankeyDiagram(Canvas* stagingCanvas, size_t row, size_t col);
