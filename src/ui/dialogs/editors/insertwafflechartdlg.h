...
namespace Wisteria::UI
    ...
    class InsertWaffleChartDlg final : public InsertGraphDlg
      ...
      public:
        ...
        /** @brief Constructs a waffle chart from the dialog's current settings.
            @param oldGraph The previous graph being edited, or @c nullptr if inserting new.
            @returns The newly constructed waffle chart.*/
        [[nodiscard]]
        std::shared_ptr<Graphs::WaffleChart>
        BuildWaffleChart(const Graphs::Graph2D* oldGraph = nullptr);
