...
namespace Wisteria::UI
    ...
    void PrinterHeaderFooterDlg::CreateControls()
        ...
        headerFrameSizer->Add(headerLeftSizer,
                              wxSizerFlags{ 1 }.Expand().Border(wxLEFT | wxBOTTOM));

        auto* leftHeaderTextLabel =
        ...
        headerFrameSizer->Add(headerCenterSizer,
                              wxSizerFlags{ 1 }.Expand().Border(wxLEFT | wxBOTTOM));
        ...
        headerFrameSizer->Add(headerRightSizer,
                              wxSizerFlags{ 1 }.Expand().Border(wxLEFT | wxBOTTOM));
        ...
        auto* leftFooterPrinterText =
            new wxStaticText(footerSizer->GetStaticBox(), wxID_STATIC, _(L"Left:"),
                             wxDefaultPosition, wxDefaultSize, 0);
        ...
        auto* centerFooterPrinterText =
            new wxStaticText(footerSizer->GetStaticBox(), wxID_STATIC, _(L"Center:"),
                             wxDefaultPosition, wxDefaultSize, 0);
        ...
        auto* rightFooterPrinterText =
            new wxStaticText(footerSizer->GetStaticBox(), wxID_STATIC, _(L"Right:"),
                             wxDefaultPosition, wxDefaultSize, 0);
