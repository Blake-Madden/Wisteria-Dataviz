...
namespace Wisteria::UI
    ...
    void InsertWordCloudDlg::CreateControls()
        ...
        GetSideBarBook()->AddPage(optionsPage, _(L"Word Cloud"), ID_OPTIONS_SECTION, true);
        ...
        auto* wordLabel = new wxStaticText(varsBox->GetStaticBox(), wxID_ANY, _(L"Word:"));
        ...
        // frequency options
        auto* freqSizer = new wxFlexGridSizer(
            2, wxSize{ wxSizerFlags::GetDefaultBorder() * 2, wxSizerFlags::GetDefaultBorder() });
