...
namespace Wisteria::UI
    {
    //-------------------------------------------------------------
    void OdsPreviewDlg::OnChangeImportMethod([[maybe_unused]] wxCommandEvent& event)
        {
        Validate();
    ...
    //-------------------------------------------------------------
    void OdsPreviewDlg::OnOK([[maybe_unused]] wxCommandEvent& event)
        {
        Validate();
        TransferDataFromWindow();
    ...
    //-------------------------------------------------------------
    void OdsPreviewDlg::CreateControls()
        {
        ...
        if (m_wrk != nullptr && !m_wrk->empty())
            ...
            m_grid->SetTable(new OdsTable(m_wrk, m_odsFile), true);
