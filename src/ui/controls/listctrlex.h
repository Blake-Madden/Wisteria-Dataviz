...
namespace Wisteria::UI
    ...
    class ListEditSpinCtrl final : public wxSpinCtrl
      ...
      public:
        ...
        ListEditSpinCtrl(wxWindow* parent, ListCtrlEx* owner, wxWindowID id = wxID_ANY,
    ...
    class ListEditSpinCtrlDouble final : public wxSpinCtrlDouble
      ...
      public:
        ...
        ListEditSpinCtrlDouble(wxWindow* parent, ListCtrlEx* owner, wxWindowID id = wxID_ANY,
    ...
    /** @brief An advanced version of ListCtrl, which has built-in support for sorting, exporting,
        ...
        @details This class is also designed to work with ListCtrlExDataProviderBase compatible
            interfaces for virtual functionality.
            In other words, a ListCtrlExDataProviderBase-derived class can easily be plugged
            into this control.
    ...
    class ListCtrlEx final : public wxListView
      ...
      public:
        ...
        struct ColumnInfo
            ...
            explicit ColumnInfo(const ColumnEditMode editMode) : m_editMode(editMode) {}

            template<typename T>
            ColumnInfo(const T Min, const T Max)
                : m_editMode(std::is_floating_point_v<T> ? ColumnEditMode::DoubleEdit :
                                                           ColumnEditMode::IntegerEdit),
        ...
        void SetColumnEditable(const long column, const bool enable = true)
            ...
            pos->second.m_editMode =
                enable ? ColumnInfo::ColumnEditMode::TextEdit : ColumnInfo::ColumnEditMode::NoEdit;
            if (enable)
                {
                EnableLabelEditing();
                }
        ...
        [[nodiscard]]
        const std::vector<std::pair<size_t, Wisteria::SortDirection>>&
        GetSortedColumns() const noexcept
            {
            return m_sortedCols;
            }
        ...
        void
        SetSortedColumns(const std::vector<std::pair<size_t, Wisteria::SortDirection>>& columns)
            {
        ...
        /// @brief Sets the help export topics and images for the list control.
        ...
        /// @brief Builds a list of base64-encode strings from the given image list,
        ///     which is later used when formatting the data to HTML.
