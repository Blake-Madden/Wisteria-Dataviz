...
namespace Wisteria::UI
    ...
    class FormattedTextCtrl final : public wxTextCtrl
      ...
      public:
        ...
        explicit FormattedTextCtrl(wxWindow* parent, wxWindowID id = wxID_ANY,
            ...
            : wxTextCtrl(parent, id, wxString{}, pos, size,
                         additionalStyles | wxTE_RICH2 | wxTE_MULTILINE | wxTE_BESTWRAP |
                             wxTE_NOHIDESEL,
                         validator, L"FormattedTextCtrl"),
              // default paper size is 8.5" x 11"
              m_paperSize(wxSize(8.5 * TWIPS_PER_INCH, 11 * TWIPS_PER_INCH))
            {
        ...
        void SetUnthemedFormattedText(const wchar_t* text) { m_unthemedContent = text; }
        ...
        [[nodiscard]]
        wxString
        GetUnthemedFormattedTextRtf([[maybe_unused]] const bool fixHighlightingTags = true);
        ...
        [[nodiscard]]
        wxString
        GetUnthemedFormattedTextHtml([[maybe_unused]] const wxString& CssStylePrefix = wxString{});
        ...
        /** @brief Searches for a given string in the control.
            ...
            @returns The index of the found text, or @c wxNOT_FOUND if not found.*/
        long FindText(const wchar_t* textToFind, const bool searchDown, const bool matchWholeWord,
        ...
        void SetTitleName(const wxString& title) { m_titleName = title; }
        ...
        /// @brief Sets the paper size.
        /// @param size The size to use.
        void SetPaperSize(const wxSize size) { m_paperSize = size; }
        ...
        void SetMarginRect(const wxRect& rectMargin) noexcept { m_rectMargin = rectMargin; }
      ...
      private:
        ...
        /// @note This will be in the native format (RTF for Windows and macOS, Pango for other UNIX
        /// systems).
        [[nodiscard]]
