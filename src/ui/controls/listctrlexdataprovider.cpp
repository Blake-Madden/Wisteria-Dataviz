...
//------------------------------------------------
int DoubleWithTextCompare::Compare(const ListCtrlExDataProviderBase::DoubleWithLabel& cell1,
    ...
    // or both items are text
        ...
        {
        return string_util::strnatordncasecmp(
            GetLabel(cell1.m_labelCode).wc_str(),
