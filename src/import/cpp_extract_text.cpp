...
namespace lily_of_the_valley
    ...
    //-----------------------------------------
    void cpp_extract_text::add_characters_strip_escapes(const wchar_t* characters,
                                                        const size_t length)
        {
        assert(characters);
    ...
    void cpp_extract_text::add_characters_strip_markup(const wchar_t* cpp_text,
        ...
        while (cpp_text < endSentinel && *cpp_text != 0)
            ...
            // before handling doxygen @ and \ symbols, make sure they aren't part of a file path
                     ...
                     (startSentinel == cpp_text ||
                      string_util::is_one_of(*(cpp_text - 1), L" \t\n\r")))
                {
                ...
                // tags that we want to skip over, but preserve the surrounding text, just step over
                // it
                ...
                // ...or a tag name that we want to copy over as part of the text
                    ...
                    {
                    const bool authorCommand =
                        (doxygenTag == L"author" || doxygenTag == L"authors");
