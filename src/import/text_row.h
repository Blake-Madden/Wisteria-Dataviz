...
namespace lily_of_the_valley
    ...
    public:
        ...
        /// @brief Adds a column that looks for a single character delimiter from a list of characters.
        /// @param column The column definition to add.
                    ...
                    for (size_t i = 0;
                        ...
                        if (currentColumnIter->get_parser().is_reading_text())
                            ...
                            if (currentPosition == nullptr)
                                ...
                                // if last read column is blank, then don't record it and just return
