...
- `"orientation"`: string specifying the orientation of the text. \
  ...
  - `"horizontal"`: Text is writting left-to-right (or right-to-left).
...
- `"text-alignment"`: How to align the label's text. \
  ...
  - `"justified"` or `"justified-at-character"`: Multiline text is tracked (space inserted) to make lines equal width. Hair spaces are inserted between each character.
  - `"justified-at-word"`: Multiline text is tracked (space inserted) to make lines equal width. Hair spaces are inserted between each word.
