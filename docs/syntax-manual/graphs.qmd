...
- `"variables"`: An item containing the following properties:
  ...
  - `"group"`: The grouping column (this is optional).
- `"group-column-count"`: If a grouping column is provided, then this number will specify the number of columns to split the groups (rows) into. \
...
- `"variables"`: An item containing the following properties:
  ...
  - `"home-game"`: The column indicating whether the was at the team's home stadium.
