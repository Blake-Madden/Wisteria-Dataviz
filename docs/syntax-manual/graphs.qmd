...
- `"pie-style"`: A string specifying the visual style for the pie chart. \
  ...
  - `"pepperoni-cheeze-pizza"`: A pepperoni pizza (slice colors will be overridden). \
    Note that the pepperonis are placed on top of the pie, so labels on the pie slices will be obscured. \
