...
- `"box-effect"`: A string specifying the effects for the boxes. \
  ...
  - `"stipple"`: Fill with a repeating image. (This will require an `"image-scheme"` to be defined.)
  ...
  - `"common-image"`: A subimage of a larger image shared by all boxes. (This will require an `"image-scheme"` to be defined.)
  - `"image"`: An image scaled down to fit the box. (This will require an `"image-scheme"` to be defined.)
  ...
  - `"pencil"`: A hand-drawn pencil effect, where the outline is drawn with a wobbly pencil line style. No fill is applied, only the outline.
...
- `"pie-style"`: A string specifying the visual style for the pie chart. \
  ...
  - `"venus"`: A Venus symbol (♀), with a thick baby pink outer ring and cross below. Slice colors will be overridden with a tinted baby pink.
  - `"mars"`: A Mars symbol (♂), with a thick baby blue outer ring and arrow above-right. Slice colors will be overridden with a tinted baby blue.
