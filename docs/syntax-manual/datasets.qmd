...
```
The above example will import the second worksheet from an *Excel* file, recoding all cells with the values `<10`, `< 10`, and `NC` as missing data.
...
- `"columns-to-keep"`: An array of strings specifying the columns to not pivot.
   These will be copied to the new dataset and will have their values filled in all new rows created from their observation.
