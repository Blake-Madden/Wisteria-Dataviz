...
- `"columns-order"`: An array of column names specifying the order in which the columns should appear after import, preserving the original spreadsheet column ordering. \
  This property is optional.
  If omitted, the column order is read directly from the source file's header.
  Any columns not listed here will be appended after the named columns in their original order.
