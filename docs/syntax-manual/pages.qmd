...
- `"watermark"`: A watermark to add to each page. \
  ...
  - `"color"`: The watermark's color. This can be either a color name or hex-encoded value.
...
- `"rows"`: The definitions of rows of content in the report. \
  This is where all embedded graphs, labels, images, etc. on the page is defined.
