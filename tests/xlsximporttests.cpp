...
TEST_CASE("xlsx_extract_text::dmy_to_excel_serial_date", "[excel_serial]")
    ...
    SECTION("Excel 1900 leap year bug")
        {
        CHECK(xlsx_extract_text::dmy_to_excel_serial_date(27, 2, 1900) == 58);
        // Both 28-Feb-1900 and 29-Feb-1900 map to 60
        CHECK(xlsx_extract_text::dmy_to_excel_serial_date(28, 2, 1900) == 59);
        CHECK(xlsx_extract_text::dmy_to_excel_serial_date(29, 2, 1900) == 60);
        CHECK(xlsx_extract_text::dmy_to_excel_serial_date(1, 3, 1900) == 61);
        }

    SECTION("Dates 1899-2001: Feb 28, Feb 29 if leap, Mar 1")
        {
        // 1899
        CHECK(xlsx_extract_text::dmy_to_excel_serial_date(28, 2, 1899) == -306);
        CHECK(xlsx_extract_text::dmy_to_excel_serial_date(1, 3, 1899) == -305);

        // 1901
        CHECK(xlsx_extract_text::dmy_to_excel_serial_date(28, 2, 1901) == 425);
        CHECK(xlsx_extract_text::dmy_to_excel_serial_date(1, 3, 1901) == 426);

        // 1904 (leap)
        CHECK(xlsx_extract_text::dmy_to_excel_serial_date(28, 2, 1904) == 1520);
        CHECK(xlsx_extract_text::dmy_to_excel_serial_date(29, 2, 1904) == 1521);
        CHECK(xlsx_extract_text::dmy_to_excel_serial_date(1, 3, 1904) == 1522);

        // 1996 (leap)
        CHECK(xlsx_extract_text::dmy_to_excel_serial_date(28, 2, 1996) == 35123);
        CHECK(xlsx_extract_text::dmy_to_excel_serial_date(29, 2, 1996) == 35124);
        CHECK(xlsx_extract_text::dmy_to_excel_serial_date(1, 3, 1996) == 35125);

        // 2000 (leap)
        CHECK(xlsx_extract_text::dmy_to_excel_serial_date(28, 2, 2000) == 36584);
        CHECK(xlsx_extract_text::dmy_to_excel_serial_date(29, 2, 2000) == 36585);
        CHECK(xlsx_extract_text::dmy_to_excel_serial_date(1, 3, 2000) == 36586);

        // 2001 (non-leap)
        CHECK(xlsx_extract_text::dmy_to_excel_serial_date(28, 2, 2001) == 36950);
        CHECK(xlsx_extract_text::dmy_to_excel_serial_date(1, 3, 2001) == 36951);
        }
    }

TEST_CASE("xlsx_extract_text::excel_serial_date_to_dmy", "[excel_serial]")
    {
    int day, month, year;

    SECTION("Excel 1900 leap year bug")
        {
        xlsx_extract_text::excel_serial_date_to_dmy(59, day, month, year);
        CHECK(day == 28);
        CHECK(month == 2);
        CHECK(year == 1900);
        // 29-Feb-1900 is 60 in Excel
        xlsx_extract_text::excel_serial_date_to_dmy(60, day, month, year);
        CHECK(day == 29);
        CHECK(month == 2);
        CHECK(year == 1900);

        xlsx_extract_text::excel_serial_date_to_dmy(61, day, month, year);
        CHECK(day == 1);
        CHECK(month == 3);
        CHECK(year == 1900);
        }
    ...
    SECTION("Dates 1899-2001: Feb 28, Feb 29 if leap, Mar 1")
        {
        // 1899
        xlsx_extract_text::excel_serial_date_to_dmy(-306, day, month, year);
        CHECK(day == 28);
        CHECK(month == 2);
        CHECK(year == 1899);

        xlsx_extract_text::excel_serial_date_to_dmy(-305, day, month, year);
        CHECK(day == 1);
        CHECK(month == 3);
        CHECK(year == 1899);

        // 1901
        xlsx_extract_text::excel_serial_date_to_dmy(425, day, month, year);
        CHECK(day == 28);
        CHECK(month == 2);
        CHECK(year == 1901);

        xlsx_extract_text::excel_serial_date_to_dmy(426, day, month, year);
        CHECK(day == 1);
        CHECK(month == 3);
        CHECK(year == 1901);

        // 1904 (leap)
        xlsx_extract_text::excel_serial_date_to_dmy(1520, day, month, year);
        CHECK(day == 28);
        CHECK(month == 2);
        CHECK(year == 1904);

        xlsx_extract_text::excel_serial_date_to_dmy(1521, day, month, year);
        CHECK(day == 29);
        CHECK(month == 2);
        CHECK(year == 1904);

        xlsx_extract_text::excel_serial_date_to_dmy(1522, day, month, year);
        CHECK(day == 1);
        CHECK(month == 3);
        CHECK(year == 1904);

        // 1996 (leap)
        xlsx_extract_text::excel_serial_date_to_dmy(35123, day, month, year);
        CHECK(day == 28);
        CHECK(month == 2);
        CHECK(year == 1996);

        xlsx_extract_text::excel_serial_date_to_dmy(35124, day, month, year);
        CHECK(day == 29);
        CHECK(month == 2);
        CHECK(year == 1996);

        xlsx_extract_text::excel_serial_date_to_dmy(35125, day, month, year);
        CHECK(day == 1);
        CHECK(month == 3);
        CHECK(year == 1996);

        // 2000 (leap)
        xlsx_extract_text::excel_serial_date_to_dmy(36584, day, month, year);
        CHECK(day == 28);
        CHECK(month == 2);
        CHECK(year == 2000);

        xlsx_extract_text::excel_serial_date_to_dmy(36585, day, month, year);
        CHECK(day == 29);
        CHECK(month == 2);
        CHECK(year == 2000);

        xlsx_extract_text::excel_serial_date_to_dmy(36586, day, month, year);
        CHECK(day == 1);
        CHECK(month == 3);
        CHECK(year == 2000);

        // 2001 (non-leap)
        xlsx_extract_text::excel_serial_date_to_dmy(36950, day, month, year);
        CHECK(day == 28);
        CHECK(month == 2);
        CHECK(year == 2001);

        xlsx_extract_text::excel_serial_date_to_dmy(36951, day, month, year);
        CHECK(day == 1);
        CHECK(month == 3);
        CHECK(year == 2001);
        }
...
TEST_CASE("XLSX read sheets", "[xlsx]")
    {
    SECTION("Read Sheet")
        {
...
TEST_CASE("XLSX read broken sheets out of order", "[xlsx]")
    {
    SECTION("Read Sheet Data Out Of Order And Missing Cells Good Dimension")
        {
        xlsx_extract_text::worksheet wrk;
        xlsx_extract_text ext{ true };
        const wchar_t* text =
    ...
    SECTION("Read Sheet Data Out Of Order And Missing Cells Bad Dimension")
        {
        xlsx_extract_text::worksheet wrk;
        xlsx_extract_text ext{ true };
        const wchar_t* text =
...
TEST_CASE("XLSX read broken sheets bad dimensions", "[xlsx]")
    {
    SECTION("Read Sheet Bad Dimension Info")
        {
        xlsx_extract_text::worksheet wrk;
        xlsx_extract_text ext{ true };
        const wchar_t* text =
    ...
    SECTION("Read Sheet No Dimension Info")
        {
        xlsx_extract_text::worksheet wrk;
        xlsx_extract_text ext{ true };
        const wchar_t* text =
...
TEST_CASE("XLSX read broken items in sheets", "[xlsx]")
    {
    SECTION("Read Sheet Broken SI Items")
        {
        xlsx_extract_text::worksheet wrk;
        xlsx_extract_text ext{ true };
        const wchar_t* text =
    ...
    SECTION("Read Sheet Broken Items")
        {
        xlsx_extract_text::worksheet wrk;
        xlsx_extract_text ext{ true };
        const wchar_t* text =
...
TEST_CASE("XLSX read broken sheets", "[xlsx]")
    {
    SECTION("Read Sheet Truncated Preview")
        {
        xlsx_extract_text::worksheet wrk;
        xlsx_extract_text ext{ true };
        const wchar_t* text =
    ...
    SECTION("Read Sheet Bad Cell Names")
        {
        xlsx_extract_text::worksheet wrk;
        xlsx_extract_text ext{ true };
        const wchar_t* text =
...
TEST_CASE("XLSX import", "[xlsx]")
    ...
    SECTION("Share Strings Split")
        ...
        CHECK(ext.get_shared_strings().at(4) == L"Taille Corps (1998)");
        CHECK(ext.get_shared_strings().at(5) == L"Age (1999)");
        CHECK(ext.get_shared_strings().at(6) == L"Poids (1999)");
        CHECK(ext.get_shared_strings().at(7) == L"Taille Corps (1999)");
        CHECK(ext.get_shared_strings().at(8) == L"Age (2000)");
        CHECK(ext.get_shared_strings().at(9) == L"Poids (2000)");
        CHECK(ext.get_shared_strings().at(10) == L"Taille Corps (2000)");
        CHECK(ext.get_shared_strings().at(11) == L"Robe");
        CHECK(ext.get_shared_strings().at(12) == L"Sexe");
        CHECK(ext.get_shared_strings().at(13) == L"Race");
        CHECK(ext.get_shared_strings().at(14) == L"Commentaires");
        CHECK(ext.get_shared_strings().at(15) == L"Tori");
        CHECK(ext.get_shared_strings().at(16) == L"Blanc et gris");
        CHECK(ext.get_shared_strings().at(17) == L"FEMELLE");
        CHECK(ext.get_shared_strings().at(18) == L"Rex du Devon");
        CHECK(ext.get_shared_strings().at(19) == L"Chesire");
        ...
        CHECK(ext.get_shared_strings().at(27) == L"Himalayen");
        CHECK(ext.get_shared_strings().at(28) == L"Cotton");
        CHECK(ext.get_shared_strings().at(29) == L"Blanc");
        CHECK(ext.get_shared_strings().at(30) == L"FEMELLE");
        CHECK(ext.get_shared_strings().at(31) == L"Siamois");
        CHECK(ext.get_shared_strings().at(32) == L"Ms. Isabelle");
        ...
        CHECK(ext.get_shared_strings().at(45) == L"Bleu de Russie");
        CHECK(ext.get_shared_strings().at(46) == L"Hobbes");
        CHECK(ext.get_shared_strings().at(47) == L"Roux et noir");
        CHECK(ext.get_shared_strings().at(48) == L"MALE");
        CHECK(ext.get_shared_strings().at(49) == L"Chat de Goutière");
        CHECK(ext.get_shared_strings().at(50) == L"Sylvester");
        ...
        CHECK(ext.get_shared_strings().at(68) == L"Bobtail Japonais");
        CHECK(ext.get_shared_strings().at(69) == L"Bigglesworth");
        CHECK(ext.get_shared_strings().at(70) == L"Sans poils");
        CHECK(ext.get_shared_strings().at(71) == L"MALE");
        CHECK(ext.get_shared_strings().at(72) == L"Sphnyx");
        CHECK(ext.get_shared_strings().at(73) == L"Napoleon");
        CHECK(ext.get_shared_strings().at(74) == L"Bleu (gris foncé)");
        CHECK(ext.get_shared_strings().at(75) == L"MALE");
        CHECK(ext.get_shared_strings().at(76) == L"Chartreux");
        // split into multiple <t> tags
        CHECK(ext.get_shared_strings().at(77) == L"Chat très difficile --manier avec prudence.");
        CHECK(ext.get_shared_strings().at(78) == L"Angel");
        CHECK(ext.get_shared_strings().at(79) == L"Blanc et noir");
        CHECK(ext.get_shared_strings().at(80) == L"FEMELLE");
        CHECK(ext.get_shared_strings().at(81) == L"Chat du Maine");
        CHECK(ext.get_shared_strings().at(82) == L"Mr. Magoo");
        CHECK(ext.get_shared_strings().at(83) == L"Ecailles de tortue");
        CHECK(ext.get_shared_strings().at(84) == L"MALE");
        CHECK(ext.get_shared_strings().at(85) == L"Chat de Goputière Angoraic Longhair");
        CHECK(ext.get_shared_strings().at(86) == L"Semble répondre au nom de \"Goober\".");
        CHECK(ext.get_shared_strings().at(87) == L"Azriel");
...
TEST_CASE("XLSX shared strings", "[xlsx]")
    ...
    SECTION("Col Index To Name")
        {
        xlsx_extract_text ext{ true };
        CHECK(ext.column_index_to_column_name(0) == L"");
        CHECK(ext.column_index_to_column_name(26) == L"Z");
        CHECK(ext.column_index_to_column_name(1) == L"A");
        CHECK(ext.column_index_to_column_name(30) == L"AD");
        CHECK(ext.column_index_to_column_name(709) == L"AAG");
    ...
    SECTION("Get ColumnRow Info")
        ...
        info = ext.get_column_and_row_info(L"AAG75895");
        CHECK(xlsx_extract_text::column_index_to_column_name(info.first.m_position) == L"AAG");
        CHECK(info.first.m_position == 709);
        CHECK(info.second == 75895);

        info = ext.get_column_and_row_info(L"bbz75895");
        CHECK(xlsx_extract_text::column_index_to_column_name(info.first.m_position) == L"BBZ");
        CHECK(info.first.m_position == 1430);
        CHECK(info.second == 75895);
