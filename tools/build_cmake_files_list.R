...
write_file(str_glue("# Automatically generated from 'build_cmake_files_list.R.R'
...
files <- files[!grepl("(rc_file_review.cpp|gtktextview-helper.cpp|codeeditor.cpp|functionbrowserdlg.cpp|demo.cpp|main.cpp|i18n-check/samples|i18n-check/tests/|cpp_i18n_review.cpp|i18n_review.cpp|utfcpp/tests/|utfcpp/samples/|utfcpp/extern)", files)]
